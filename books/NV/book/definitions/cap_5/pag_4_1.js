const defBoards = {
  ...
  board_5: {
    ...
    points: [
      ...
      {  text: {value: "0", position: [-6.17, -3]},},
      {
      visible:false
      },
      {
        text: {value: "72", position: [-1.5, -3]},
      },
    ],
    type: 1,
  },
